# Legacy Obsisphere README / Development Roadmap

> This file preserves the previous project README for historical context. It is no longer the primary description of the current feature set. See [`../FEATURES.md`](../FEATURES.md) and the root [`README.md`](../README.md) for current documentation.
